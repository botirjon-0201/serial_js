...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modal */ "./src/modules/modal.js");
/* harmony import */ var _sever_sever__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../sever/sever */ "./src/sever/sever.js");
...
function form(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (event) {
      ...
      (0,_sever_sever__WEBPACK_IMPORTED_MODULE_10__.postData)("http://localhost:3000/request", json).then(function (data) {
        console.log(data);
        showThanksModal(msg.success);
        statusMessage.remove();
      })["catch"](function () {
        showThanksModal(msg.failture);
      })["finally"](function () {
        form.reset();
      });
    });
...
function slider(_ref) {
  ...
  dots.forEach(function (dot) {
    dot.addEventListener("click", function (evnt) {
      var slideTo = evnt.target.getAttribute("data-slide-to");
      slideIndex = slideTo;
...
function timer(id, deadline) {
  ...
  function getZero(num) {
    return num >= 0 && num < 10 ? "0".concat(num) : num;
  }
